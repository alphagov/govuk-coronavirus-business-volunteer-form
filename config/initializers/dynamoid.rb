...
Dynamoid.configure do |config|
  ...
  unless Rails.env.production?
    ...
    if Rails.env.development?
      Rails.configuration.submissions_db_table_name = "coronavirus-business-form-development"
    elsif Rails.env.test?
      Rails.configuration.submissions_db_table_name = "coronavirus-business-form-test"
    end
  end
end
