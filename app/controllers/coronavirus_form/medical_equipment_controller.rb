...
class CoronavirusForm::MedicalEquipmentController < ApplicationController
  ...
  def submit
    ...
    if invalid_fields.any?
      ...
      controller = medical_equipment == I18n.t("coronavirus_form.#{PAGE}.options.number_yes.label") ? 'coronavirus_form/medical_equipment_kind' : 'coronavirus_form/hotel_rooms'
